...
namespace :js do
  task :update do
    `jim install http://www.modernizr.com/downloadfulljs/ modernizr 1.7`
    `jim install http://documentcloud.github.com/underscore/underscore.js underscore 1.1.4`
    `jim install http://documentcloud.github.com/backbone/backbone.js backbone 0.3.3`
    `jim install http://ajax.googleapis.com/ajax/libs/jquery/1.4.4/jquery.js jquery 1.4.4`
    `jim install http://ajax.googleapis.com/ajax/libs/jquery/1.5.1/jquery.js jquery 1.5.1`
